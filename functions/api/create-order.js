...
export async function onRequestPost({ request, env }) {
  ...
  if (promo === "lipiec") {
    ...
    normalized === "wrzesien16" ||
    normalized === "wrzesien17" ||
    normalized === "wrzesien18" ||
    normalized === "wrzesien19" ||
    normalized === "wrzesien20" ||
    normalized === "wrzesien21" ||
    normalized === "wrzesien22" ||
    normalized === "wrzesien23" ||
    normalized === "wrzesien24" ||
    normalized === "wrzesien25" ||
    normalized === "wrzesien26" ||
    normalized === "wrzesien27" ||
    normalized === "wrzesien28" ||
    normalized === "wrzesien29" ||
    normalized === "wrzesien30"
  ) {
    ...
    normalized === "integracja16" ||
    normalized === "integracja17" ||
    normalized === "integracja18" ||
    normalized === "integracja19" ||
    normalized === "integracja20" ||
    normalized === "integracja21" ||
    normalized === "integracja22" ||
    normalized === "integracja23" ||
    normalized === "integracja24" ||
    normalized === "integracja25" ||
    normalized === "integracja26" ||
    normalized === "integracja27" ||
    normalized === "integracja28" ||
    normalized === "integracja29" ||
    normalized === "integracja30" ||
    promo === "poznan"
  ) {
